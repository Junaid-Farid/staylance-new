...
/* @var $this yii\web\View */
    ...
    $this->title = Yii::t('app', 'Create Traveller Help');
    ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <?php if (count($descriptionmodel) > 0) { ?>
                <a href="<?php echo Url::to(['/travellerphoto/update', 'id' => $descriptionmodel->id]); ?>" class="btn btn-arrow">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <a href="<?php echo Url::to(['/travellerphoto/update', 'id' => $descriptionmodel->id]); ?>" class="btn btn-back-text">back</a>
            <?php } else { ?>
