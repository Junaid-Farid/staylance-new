...
<div class="form-group wrap_container">
    ...
    <script>
        $(function () {
<?php if (isset($modelAttachments)) { ?>
                var path = "<?php echo Yii::$app->urlManager->baseUrl . '/../../profiles/travellers/' . $modelAttachments->orignal_name; ?>";
                $('.my-image-preview').css("background-image", "url('" + path + "')");
                $('.cropit-image-preview').css("background-image", "url('" + path + "')");
